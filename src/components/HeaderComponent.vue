...
<script setup>
import { inject, computed, onMounted } from 'vue'; // Import inject, computed, and onMounted
...
onMounted(() => {
  ...
  console.log("HeaderComponent.vue mounted.");
});
</script>
...
.navbar {
  /* Example: Add some padding if needed */
  /* padding-top: 0.5rem; */
